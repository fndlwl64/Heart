        ...
        <div class="border qna-content">
            <div class="content-header">
                ...
                <div class="header-info">
                    <ul>
                        <li class="d-inline"><img src="/image/heartpet_logo.png" alt=""></li>
                        <li class="d-inline">
                            <a href="/mypage"><span id="id">${ id } 아이디</span></a>
                ...
                <div id="content-scroll">
                    <div class="content-body">
                        <div class="qna-image shadow-sm my-3 bg-body rounded">
                            <img src="/image/potter.jpg" class="rounded mx-auto d-block" alt="qna_image">
                        </div>
            ...
            <div class="content-buttons">
                <%-- 내 글인 경우 --%>
                <button type="submit" class="btn btn-success" onclick="location.href='/user_qna_update'"><i class="bi bi-eraser"></i> 수정</button>
                <button type="submit" class="btn btn-danger" onclick="location.href=''"><i class="bi bi-trash3"></i> 삭제</button>
                <%-- 여기까지 --%>
                <button type="submit" class="btn btn-dark" onclick="location.href='/user_qna_list'"><i class="bi bi-card-list"></i> 목록</button>
            </div>
        </div>
    </div>
