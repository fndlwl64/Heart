	...
	<div class="d-flex justify-content-end m-3">
		<div class="row row-cols-auto rounded-3 m-2"
			...
			<img class="col img-thumbnail w-50"
				src="https://cdn.pixabay.com/photo/2018/05/13/16/57/dog-3397110_960_720.jpg">
			<div class="col-2 m-1">
				<dl class="m-2">
					<dt class="mx-2">이름</dt>
					<dd class="mx-2">19423-345</dd>
				</dl>
				<dl class="m-2">
					<dt class="mx-2">품종</dt>
					<dd class="mx-2">포메라니안</dd>
				</dl>
				<dl class="m-2">
					<dt class="mx-2">성별</dt>
					<dd class="mx-2">수컷</dd>
			...
			<div class="col-2 m-1">
				...
				<dl class="m-2">
					<dt class="mx-2">나이</dt>
					<dd class="mx-2">6(세)</dd>
				</dl>
				<dl class="m-2">
					<dt class="mx-2">체중</dt>
					<dd class="mx-2">6.18(Kg)</dd>
				</dl>
				<dl class="m-2">
					<dt class="mx-2">입양상태</dt>
					<dd class="mx-2">입양대기</dd>
				</dl>
			</div>
		</div>
	</div>
