...
<div class="container">
    ...
    <%-- 검색 폼 --%>
    <form class="search_form" action="${path }/admin_dog_search" method="post">
        <div class="form_box">

            <input name="keyword" placeholder="유기견 종 입력">
    ...
    <button class="btn btn-success insertbtn" onclick="location.href='${path}/pet_insert'">등록</button>
    ...
    <div class="lists">
        <table class="table searched_list">
            ...
            <tr>
                <td><a href="${path}/dog_view">1</a></td>
                <td>푸들</td>
                <td>암컷</td>
                <td>중형견</td>
                <td>yes</td>
                ...
                <td></td>
                <td>
                    <button class="btn btn-primary" onclick="location.href='${path}/pet_update'">수정</button>
        ...
        <div id="myInput" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" onclick="location.href='${path}/admin_dog_delete'">삭제</button>
                </div>
            </div>
        </div>
    </div>
