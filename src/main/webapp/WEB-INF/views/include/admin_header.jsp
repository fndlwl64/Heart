		...
		<div class="row div_header">
			...
			<div class="nav-bar justify-content-center">
				<ul>
					...
					<li class="lis"><a href="${path}/admin_qna_list">Q&A관리</a></li>
					<li class="lis"><a href="${path}/admin_fnq_list">FNQ관리</a></li>
					<li class="lis"><a href="${path}/admin_review_list">후기관리</a></li>
				</ul>
			</div>
		</div>
	</div>
