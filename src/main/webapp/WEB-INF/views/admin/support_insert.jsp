	...
	<form method="post" action="${path }/support_insert_ok" onsubmit="return submitOption();">
		<table class="table">
			<tr>
				...
				<td><input id="sup_user" name="support_userid" class ="input1" type="text"></td>
			</tr>
			<tr>
				<th class="table-secondary"><span class="sp2">금액</span></th>
				<td><input id="sup_price" name="support_price" class ="input1" type="text"></td>
			</tr>
			<tr>
				<th class="table-secondary"><span class="sp2">후원일자</span></th>
				<td><input id="sup_date" name="support_date" class ="input1" type="text"></td>
			</tr>
		</table>
		<br>
