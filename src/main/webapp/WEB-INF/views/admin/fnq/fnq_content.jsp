...
<div class="container">
    ...
    <div class="buttons">
	    ...
	    <button class="btn btn-danger mx-1" data-bs-toggle="modal" data-bs-target="deleteModal" data-id="${ path }/user_fnq_delete?fnq_no=${ list.fnq_no }"><i class="bi bi-trash3"></i> 삭제하기</button>
