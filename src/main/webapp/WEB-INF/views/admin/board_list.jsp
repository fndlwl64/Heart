...
<body>
    ...
    <div class="container">
        ...
        <button class="btn btn-success insertbtn" onclick="location.href='/board_insert'">등록</button>
        ...
        <div class="lists">
            ...
            <table class="table searched_list">
                ...
                <tr>
                    ...
                    <td>1</td>
                    <td>
                        <button class="btn btn-primary" onclick="location.href='/board_update'">수정</button>
