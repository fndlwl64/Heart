...
<body>
    ...
    <div class="container">
        ...
        <%-- 검색 폼 --%>
        <form class="search_form" method="post" action="${path }/admin_user_search">
            <div class="form_box">
                <select name="field">
        ...
        <button class="btn btn-success insertbtn" onclick="location.href='${path}/board_insert'">등록</button>
        ...
        <div class="lists">
            ...
            <table class="table searched_list">
                ...
                <tr>
                    ...
                    <td>1</td>
                    <td>
                        <button class="btn btn-primary" onclick="location.href='${path}/board_update'">수정</button>
            ...
            <div id="myInput" class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger" onclick="location.href='${path}/admin_board_delete'">삭제</button>
                    </div>
                </div>
            </div>
        </div>
