            		...
            		<table class="table table-sm" id="search-table">
	            		<tr>
	                      	...
	                      	<td width="37.5%" colspan="3">
			                    ...
			                    <label><input type="radio" name="animal_size" value="대형" <c:if test="${animalDTO.animal_size eq '대형' }">selected</c:if>/> 대형</label>
								<label><input type="radio" name="animal_size" value="중형" <c:if test="${animalDTO.animal_size eq '중형' }">selected</c:if> /> 중형</label>
								<label><input type="radio" name="animal_size" value="소형" <c:if test="${animalDTO.animal_size eq '소형' }">selected</c:if> /> 소형</label>
	                      	  </div>
	                      	</td>
                      	<tr>
