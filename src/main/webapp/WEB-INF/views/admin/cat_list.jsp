...
<div class="container">
    ...
    <%-- 검색 폼 --%>
    <form class="search_form" action="${path}/admin_cat_search" method="post">
        <div class="form_box">
    ...
    <div class="lists">
        <table class="table searched_list">
            ...
            <tr>
                <td><a href="${path}/cat_view">1</a></td>
                <td>먼치킨</td>
                <td>암컷</td>
                <td>소</td>
                <td>yes</td>
        ...
        <div id="myInput" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" onclick="location.href='${path}/admin_cat_delete'">삭제</button>
                </div>
            </div>
        </div>
    </div>
