...
<body>
    ...
    <div class="container">
        ...
        <br>
        <%-- 검색 폼 --%>
        <form class="search_form" method="post" action="${path }/admin_adoptreg_search">
            <div class="form_box row">
                <div class="col">
                    <label >
                        입양등록일 : <input type="date" name="searchSdate" title="입양등록일">
                    </label>

                    <label>
                        입양예정일 : <input type="date" name="searchSdate" title="입양등록일">
                    </label>

                    <label>
                        입양완료일 : <input type="date" name="searchSdate" title="입양등록일">
                    </label>
                </div>
        ...
        <button class="btn btn-success insertbtn" onclick="location.href='${path }/adoptreg_insert'">등록</button>
            ...
            <div id="myInput" class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger" onclick="location.href='${path}/admin_adoptreg_delete'">삭제</button>
                    </div>
                </div>
            </div>
        </div>
