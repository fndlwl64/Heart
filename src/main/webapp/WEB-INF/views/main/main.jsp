...
<div id="main-contents" class="main-contents">
    ...
    <div class="swiper dogSwiper">
        <div class="swiper-wrapper">
            <div class="swiper-slide"><a href="/user_dog_content"><img src="/logo/heartpet_logo.png" alt=""></a></div>
            <div class="swiper-slide"><img src="/logo/heartpet_logo_words.png" alt=""></div>
    ...
    <div class="more">
        <button type="button" class="btn btn-dark" onclick="location.href='/user_dog_list'">더 보러가기</button>
    </div>
    <%-- 입양후기 list 출력 --%>
    ...
    <div class="swiper reviewSwiper">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <a href=""><img src="/logo/heartpet_logo.png" /></a>
                <span class="title">후기제목</span><br>
                <span class="content">후기내용</span>
            </div>
            <div class="swiper-slide">
                <a href=""><img src="/logo/heartpet_logo_words.png" /></a>
