...
insert into heartpet_board values(1, '입양', 'user', 0, '게시판 제목 1', '게시판 1내용입니다', 'N');
insert into heartpet_board values(2, '입양', 'user1', 0, '게시판 제목 2', '게시판 2내용입니다', 'N');
insert into heartpet_board values(3, '입양', 'user1', 0, '게시판 제목 3', '게시판 3내용입니다', 'N');
