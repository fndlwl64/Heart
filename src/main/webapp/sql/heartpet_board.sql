...
insert into heartpet_board values(1, default, '입양', 'user', 0, '게시판 제목 1', '게시판 1내용입니다', 'N', '1234', sysdate, null, null, null);
insert into heartpet_board values(2, default, '입양', 'user1', 0, '게시판 제목 2', '게시판 2내용입니다', 'N', '1234', sysdate, null, null, null);
insert into heartpet_board values(3, default, '입양', 'user1', 0, '게시판 제목 3', '게시판 3내용입니다', 'N', '1234', sysdate, null, null, null);
...
SELECT LEVEL, 
       board_no, 
       board_parentNo, 
       LPAD(' ', 4*(LEVEL-1)) || board_title as title,
       board_content,
       board_id,
       board_hit,
       board_secret,
