...
insert into heartpet_review values (1, 'user1', '1', default, '입양후기 제목 1', '입양후기1내용입니다.', sysdate, '사진1', '사진2', '사진3', '동영상1');
insert into heartpet_review values (2, 'user1', '2', default, '입양후기 제목 2', '입양후기2내용입니다.', sysdate, '사진1', '사진2', '사진3', '동영상2');
insert into heartpet_review values (3, 'user1', '3', default, '입양후기 제목 3', '입양후기3내용입니다.', sysdate, '사진1', '사진2', '사진3', '동영상3');
