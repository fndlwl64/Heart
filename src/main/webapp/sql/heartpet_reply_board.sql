...
insert into heartpet_reply_board values(1, 1, '입양', 'user', 0, '게시판답글제목1', '게시판답글내용1', 'N', sysdate, null, null, null);
insert into heartpet_reply_board values(2, 2, '입양', 'user1', 0, '게시판답글제목1', '게시판답글내용1', 'N', sysdate, null, null, null);
